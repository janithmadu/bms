    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <nav className="relative z-10 container mx-auto px-4 py-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <span className="font-bold text-2xl text-slate-900">BookingHub</span>
      ...
      <div className="relative z-10 container mx-auto px-4 py-16">
        <div className="text-center max-w-5xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-slate-600 mb-12 max-w-3xl mx-auto leading-relaxed">
            ...
            <span className="font-semibold text-slate-700">Smart token management</span> meets 
            <span className="font-semibold text-slate-700"> beautiful design</span> for the ultimate meeting experience.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
            <Button size="lg" asChild className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-200 px-8 py-4 text-lg">
              <Link href="/booking">
                Start Booking Now
                <ArrowRight className="ml-3 h-6 w-6" />
              </Link>
            </Button>
            <Button size="lg" variant="outline" asChild className="bg-white/80 backdrop-blur-sm border-white/20 hover:bg-white shadow-lg px-8 py-4 text-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
              ...
              <h3 className="font-bold text-xl text-slate-900 mb-3">Multiple Locations</h3>
              <p className="text-slate-600 leading-relaxed">Seamlessly manage bookings across all your office locations with centralized control.</p>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
              ...
              <h3 className="font-bold text-xl text-slate-900 mb-3">Smart Booking</h3>
              <p className="text-slate-600 leading-relaxed">Intelligent calendar system with real-time conflict detection and availability optimization.</p>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
              ...
              <h3 className="font-bold text-xl text-slate-900 mb-3">Token System</h3>
              <p className="text-slate-600 leading-relaxed">Fair usage management with automatic monthly renewal and transparent token tracking.</p>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
              ...
              <h3 className="font-bold text-xl text-slate-900 mb-3">Team Collaboration</h3>
              <p className="text-slate-600 leading-relaxed">Built for teams of all sizes with role-based access and collaborative booking features.</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
            <div className="space-y-8">
              <h2 className="text-4xl font-bold text-slate-900">Why Choose BookingHub?</h2>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-bold text-xl text-slate-900 mb-2">Instant Booking</h3>
                    <p className="text-slate-600">Book meeting rooms in seconds with our streamlined interface and real-time availability.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-bold text-xl text-slate-900 mb-2">Enterprise Security</h3>
                    <p className="text-slate-600">Bank-level security with role-based access control and comprehensive audit trails.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-bold text-xl text-slate-900 mb-2">User Management</h3>
                    <p className="text-slate-600">Advanced user management with location-based access control and permission systems.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <footer className="relative z-10 container mx-auto px-4 py-12 border-t border-white/20 mt-20">
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <p className="text-sm text-slate-500">© 2024 BookingHub. Built with Next.js, Tailwind CSS, and modern web technologies.</p>
        </div>
      </footer>
    </div>
  )
